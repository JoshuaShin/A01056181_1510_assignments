...
class TestCombatInitiative(TestCase):
    ...
    def test_combat_initiative_opponent_1_wins(self, mock_input):
    ...
    def test_combat_initiative_opponent_2_wins(self, mock_input):
    ...
    def test_combat_initiative_tie(self, mock_stdout, mock_input):
